...
#define NEWSESSION_ELEMENT_HREF		IFMAP_HREF
...
#define PURGEPUBLISHER_ELEMENT_NAME	"purgePublisher"
#define PURGEPUBLISHERRECV_ELEMENT_NAME	"purgePublisherReceived"
#define PURGEPUBLISHERRECV_ELEMENT_HREF	NO_HREF
